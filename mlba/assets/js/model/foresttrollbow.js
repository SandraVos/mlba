...
switch(user) {
  ...
  case 'attack':
    var weapon = prompt("With what will you fight? Bow or bare hands?").toLowerCase();
      switch(weapon){
        case 'bow':
          console.log("You quickly draw your bow and run to the nearest bush. Vividly like an elf you hop through the forest around the ogre shooting one arrow after another. The ogre never new what got to him and still with the surprise on his face he falls on the ground. What did that ogre ever done to you?! At least you can pass now... Hope you're feeling happy about yourself!");
        break;
